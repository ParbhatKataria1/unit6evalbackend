...
const getPosts = async(req, res)=>{
    let {page, min, max, device} = req.query;
    ...
    try {
       ...
       let data;
       if(page){
           data = await PostModel.find(obj).skip((page-1)*3).limit(3);
       }
       else {
        data = await PostModel.find(obj).limit(3);
       }
...
module.exports = {addPost,getPosts,  getTopData, updateData, deleteData}
